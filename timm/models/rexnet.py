...
from .layers import ClassifierHead, create_act_layer, ConvBnAct, DropPath, MultiRankTreeHead, ClassifierMLPHead
...
class ReXNetV1(nn.Module):
    def __init__(self, in_chans=3, num_classes=1000, global_pool='avg', output_stride=32,
                 ...
                 ch_div=1, drop_rate=0.2, drop_path_rate=0., feature_location='bottleneck', head_type='ClassifierHead'):
        ...
        self.head = globals()[self.head_type](self.num_features, num_classes, global_pool, drop_rate)
    ...
    def reset_classifier(self, num_classes, global_pool='avg'):
        self.head = globals()[self.head_type](self.num_features, num_classes, pool_type=global_pool, drop_rate=self.drop_rate)
